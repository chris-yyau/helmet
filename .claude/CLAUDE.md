...
| `pinact.yml` | Push + PR | Auto-pin GitHub Actions to SHA |
| `scorecard.yml` | Weekly + push | OpenSSF security health score |
...
- **Permissions:** Top-level `permissions: {}` deny-all, per-job grants only
